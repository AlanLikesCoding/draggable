...
export const Draggable = ({ children }) => {
    ...
    const handleMouseDown = (e) => {
        ...
        parentRef.current = (element === null || element === void 0 ? void 0 : element.parentElement) || null; // Store parent reference here
    ...
    const handleMouseUp = () => {
        ...
        if (element) {
            ...
            // Clear the transition after it finishes
    ...
    return (React.createElement("div", { key: 'draggable-' + id, id: 'draggable-' + id, ref: ref, style: {
            cursor: isDragging ? 'grabbing' : 'grab',
            userSelect: 'none',
            backgroundColor: isDragging ? 'pink' : 'lightgreen',
        }, onMouseDown: handleMouseDown, onMouseMove: handleMouseMove, onMouseUp: handleMouseUp }, children));
};
